...
integer(c_size_t), parameter :: &
    sizeof_real      = STORAGE_SIZE(sdummy)/STORAGE_SIZE('1'), &
    sizeof_double    = STORAGE_SIZE(ddummy)/STORAGE_SIZE('1'), &
    sizeof_complex   = STORAGE_SIZE(cdummy)/STORAGE_SIZE('1'), &
    sizeof_complex16 = STORAGE_SIZE(zdummy)/STORAGE_SIZE('1'), &
    sizeof_int       = STORAGE_SIZE(idummy)/STORAGE_SIZE('1'), &
    sizeof_ptr       = STORAGE_SIZE(ptr_dummy)/STORAGE_SIZE('1')
